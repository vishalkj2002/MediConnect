          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus quaerat cumque fugit, perspiciatis cum nemo apeiam, aut quia earum amet architecto, modi odio. Soluta unde ducimus perferendis?</p>
